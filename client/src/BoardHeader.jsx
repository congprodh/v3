export default function BoardHeader() {
    return (
        <>
            <div className="h-20 bg-cover bg-[url('https://c1.wallpaperflare.com/preview/495/109/110/orange-texture-texture-wall-background.jpg')]">
            </div>
            <div className=' bg-dark-brighter'>
                <div className="mx-6 relative flex">
                    <div className='h-20 w-20 rounded-full overflow-hidden relative -top-4 border-3 border-white bg-white'>
                        <img className=" object-cover" src="https://styles.redditmedia.com/t5_2qs0q/styles/communityIcon_kxcmzy9bt1381.jpg" alt="" />
                    </div>
